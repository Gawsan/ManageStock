...
<body>
	...
	<nav class="navbar navbar-light" style="background-color:#ffc107;">
		<div class="container">
			<h2><i class="fas fa-folder-plus"></i> Remove Stock</h2>
		</div>
	</nav>
		...
		<div>
			...
			<form action="remove" method="POST">
				...
				<div class="form-group">
					...
					<input type="text" id="productname" name="pname" placeholder="HP probook" class="form-control" required="required" value="<%=name%>" readonly>
				</div>
				
				<div class="form-group">
					<label for="inputBI">Price per Unit: </label>
					<input type="number" id="price" name="price" placeholder="178000" class="form-control" required="required" value="<%=price%>" readonly>
				</div>
				
				<div class="form-group">
					<label for="inputQuantity">Date of Manufacture: </label>
					<input type="date" id="mfd" name="mfd" placeholder="2020-08-09" class="form-control" required="required" value="<%=Mfd%>" readonly>
				</div>
				
				<div class="form-group">
					<label for="inputPrice">Product Category: </label>
					<input type="text" id="cat" name="category" placeholder="Laptop" class="form-control" required="required" value="<%=category%>" readonly>
				</div>
				
				<div class="form-group">
					<label for="inputDOM">Product Location: </label>
					<input type="text" id="location" name="location" placeholder="Location" class="form-control" required="required" value="<%=loc%>" readonly>
				</div>
				
				<div class="form-group">
					<label for="inputDOE">Qunatity: </label>
					<input type="number" id="qty" name="qty" placeholder="20" class="form-control" required="required" value="<%=qty%>" readonly>
				</div>
				<div class="form-group">
					<label for="inputDOE">Avilable Product: </label>
					<input type="number" id="avilable" name="avilable" placeholder="100" class="form-control" required="required" value="<%=unit%>" readonly>
				</div>
			
				
				<div class="row">
					<div class="col text-center">
						<input type="submit" value="Remove stock" class="btn btn-success btn-block removestock" onclick="return confirm('Are you sure you want to Delete Stock?')">
					</div>
				</div>
